...
function CreateBlog(){
    ...
    <div className="w-screen flex justify-center items-center pt-7 pb-3">
        <div className="w-[90vw]">
            <div className="flex border-black border-2 max-w-min whitespace-nowrap p-3 hover:border-transparent hover:bg-purple-500 hover:text-white" onClick={()=>{navigate("/blog/addpost")}}>
